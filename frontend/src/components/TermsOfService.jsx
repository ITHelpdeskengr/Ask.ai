    ...
    <div style={{
      ...
      <div style={{
        ...
        <div className="md-content" style={{ lineHeight: '1.8' }}>
          ...
          <p>By accessing or using HELPDESK, you agree to be bound by these Terms of Service. If you do not agree to all of these terms, do not use the service.</p>

          <h2>2. Description of Service</h2>
          <p>HELPDESK is an intelligent AI assistant that integrates with your digital workspace (Google Calendar, Gmail, Drive) to help you manage tasks, meetings, and information more efficiently.</p>
          ...
          <p>The service and its original content, features, and functionality are and will remain the exclusive property of HELPDESK and its licensors.</p>
          ...
          <p>In no event shall HELPDESK, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.</p>

          <h2>8. Governing Law</h2>
          <p>These Terms shall be governed and construed in accordance with the laws of the jurisdiction in which HELPDESK operates, without regard to its conflict of law provisions.</p>
